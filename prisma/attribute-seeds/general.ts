// prisma/attribute-seeds/general.ts
// Purpose: Seeds General store attribute definitions.
// Run: npx tsx prisma/attribute-seeds/general.ts
...
async function main() {
  const definitions = [
    ...
    { key: "size", label: "Size", unit: null, inputType: AttributeInputType.SELECT, isFilterable: true, sortOrder: 1, allowedValues: ["Small", "Medium", "Large", "XL", "One Size"] },
  ];
